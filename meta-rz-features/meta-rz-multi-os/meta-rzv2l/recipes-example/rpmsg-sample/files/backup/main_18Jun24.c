...
void ble_queue_reception(void)
{
    ...
    // LPRINTF("\n RPMSG_INFO:Received command ID: %02X\n", command_id);
    // LPRINTF("\n RPMSG_INFO:Received data: ");
    ...
    // clearing msg queue Error
        // if(msgctl(msgid, IPC_RMID, NULL) == -1) {
        //     perror("msgctl");
        //     exit(EXIT_FAILURE);
        // } else {
        //     LPRINTF("\nRPMSG_INFO: Message queue cleared");
        // }

    switch (command_id)
    {

    case 0x01: /* Start & stop harvesting */
    ...
    case 0x02: /* Load cell tare function */
    ...
    case 0x03: /* Load cell Calibration function */
